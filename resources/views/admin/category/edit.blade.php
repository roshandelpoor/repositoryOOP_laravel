            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Category Edit {{ $category->title }}</h4>
                                ...
                                <form action="{{ route('category.update',['category' => $category->id]) }}" method="post"
                                    ...
                                    <div class="form-group">
                                        <label for="logo">Logo | <a href="{{ $category->logoLink() }}" target="_blank"><i class="fa fa-download"></i></a></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" data-toggle="switchery" id="status" name="status"
